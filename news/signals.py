...
def notify_about_new_post(sender, instance, **kwargs):
    if kwargs['action'] == 'post_add':
        ...
        # print(subs)
        #        send_notifications(instance.preview(), instance.pk, instance.heading, subs).delay()
        send_notifications.delay(instance.preview(), instance.pk, instance.heading, subs)
